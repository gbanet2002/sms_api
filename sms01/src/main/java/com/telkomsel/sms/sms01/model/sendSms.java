...
public class sendSms {
	...
	public String send(String sender_id, String recipient, String sms_text) {
		
		
		//sms_text = sms_text + ";" + email;
		
		String result = "000";
		
		// Initialize Mashery variable
		//String api_key = "j825nhcsrk24tdg28jj6by8j";
		//String api_secret = "DDzgb";
